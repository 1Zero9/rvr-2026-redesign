    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Instagram link at the bottom of the mobile drawer */}
          <div className="shrink-0 px-5 py-4 border-t border-brand-sky/15">
            <a
              href="https://www.instagram.com/rvrfc1981"
              target="_blank"
              rel="noopener noreferrer"
              onClick={close}
              className="flex items-center gap-3 min-h-[44px] text-brand-sky/70 hover:text-brand-neon transition-colors"
            >
