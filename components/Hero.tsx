  ...
  return (
    <section className="relative min-h-[80vh] w-full overflow-hidden flex items-center justify-center bg-brand-charcoal text-white border-b-4 border-brand-charcoal">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        >
          {/* Public high-quality soccer training video loop */}
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-soccer-player-kicking-ball-in-rain-4893-large.mp4"
            type="video/mp4"
          />
          {/* Fallback poster or gradient if video fails */}
        </video>
        {/* Cute-alism grid mesh overlay + Dark Gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-brand-charcoal/80 via-transparent to-brand-charcoal/95"></div>
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"></div>
      </div>

      {/* Decorative Starbursts & Stickers (Cute-alism playfulness) */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-20 flex flex-col items-center">
        ...
        <span className="inline-block bg-brand-neon text-brand-charcoal font-display font-black text-xs md:text-sm px-5 py-2 rounded-full uppercase tracking-wider mb-8 border-3 border-brand-charcoal shadow-brutalist rotate-[-2deg] hover:rotate-0 transition-transform cursor-default">
          Dublin, Ireland • Rivervalley Rangers AFC
        </span>
        
        {/* Main Angled Headline */}
