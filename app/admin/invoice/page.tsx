      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6">
          ...
          <p className="text-brand-charcoal/60 text-sm mt-1">
            ...
            Seeded from the git history; add a rate to whichever lines you want to bill.
          </p>
        </div>
        ...
        {items.length === 0 ? (
          ...
          <div className="space-y-2">
            {items.map((item) => (
              <div
                key={item.id}
                className="bg-white border-2 border-brand-charcoal/10 p-3 flex flex-col sm:flex-row sm:items-center gap-3"
              >
