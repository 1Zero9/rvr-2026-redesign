...
export const CLUB_TEAMS: ClubTeam[] = [
  {
    ...
    description: 'Little Rangers is our introductory football programme for children aged 4–5. A fun, safe, and welcoming environment to take their first kicks.',
    marketingCopy: 'Is your child ready for their first football experience? Little Rangers introduces the beautiful game through play, movement, and fun. No experience needed — just enthusiasm!',
  ...
  },
  {
    ...
    description: 'The RVR Academy develops players aged 6–7 in a structured but enjoyable environment before they enter the DDSL age group pathway.',
    marketingCopy: 'The RVR Academy is where future Rangers are made. We focus on fundamentals, teamwork, and a love of the game in a fully coached, age-appropriate setting.',
    trainingDay: 'Saturday',
    trainingTime: 'TBC',
    trainingVenue: 'Rivervalley Park, Swords',
    isRecruiting: true,
  ...
  },
  {
    ...
    category: 'community',
    badge: '⚽',
    tagline: 'Football for the women of RVR',
    description: "Mams' Football at River Valley Rangers is a fun, social football session open to all women connected to the club and the wider Swords community.",
    marketingCopy: "You drop them off every weekend — now it's your turn. Mams' Football is a welcoming, fun session for women of all abilities. No experience needed, just show up.",
    trainingDay: 'TBC',
    trainingTime: 'TBC',
    trainingVenue: 'Rivervalley Park, Swords',
    isRecruiting: true,
